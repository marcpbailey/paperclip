...
not start C until B is committed. Do not start D until C is committed. Each
conversation starts by reading the latest committed state of the files it will
modify.
